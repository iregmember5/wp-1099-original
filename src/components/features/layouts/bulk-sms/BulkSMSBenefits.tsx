...
export const BulkSMSBenefits: React.FC<{
  benefits: any[];
  heading?: string;
  description?: string;
  ...
  <section className="py-24 lg:py-32 relative overflow-hidden">
    <div className="absolute inset-0">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-5" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="sms-bg-pattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            <rect x="10" y="30" width="60" height="40" rx="8" stroke="white" strokeWidth="1" fill="none" />
            <circle cx="25" cy="50" r="2" fill="white"/>
            <circle cx="40" cy="50" r="2" fill="white"/>
            <circle cx="55" cy="50" r="2" fill="white"/>
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#sms-bg-pattern)" />
      </svg>
    </div>
