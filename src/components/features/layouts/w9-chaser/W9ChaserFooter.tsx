...
import { type FeaturesPageData, type ImageData } from "../../../../types/features-page";
...
export function W9ChaserFooter({ data }: FooterProps) {
  const footerConfig = data.footer_config as FooterConfig | undefined;
